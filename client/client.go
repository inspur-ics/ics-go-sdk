...
//
//func (c *Client) GetTrip(ctx context.Context, api types.ICSApi, req, res interface{}) (*restful.Response, error) {
//	return c.RestAPITripper.GetTrip(ctx, api, req, res)
//}
//
//func (c *Client) PostTrip(ctx context.Context, api types.ICSApi, req, res interface{}) (*restful.Response, error) {
//	return c.RestAPITripper.PostTrip(ctx, api, req, res)
//}
//
//func (c *Client) PutTrip(ctx context.Context, api types.ICSApi, req, res interface{}) (*restful.Response, error) {
//	return c.RestAPITripper.PutTrip(ctx, api, req, res)
//}
//
//func (c *Client) DeleteTrip(ctx context.Context, api types.ICSApi, req, res interface{}) (*restful.Response, error) {
//	return c.RestAPITripper.PutTrip(ctx, api, req, res)
//}
