...
func RebootVMById(ctx context.Context, r restful.RestAPITripper, vmId string) (*types.Task, error) {
	var reqBody *types.Common
	var api types.ICSApi
	var response = types.Task{}
	...
	api.Api = fmt.Sprintf("/vms/%s?action=reboot", vmId)
	api.Token = true
...
func PauseVMById(ctx context.Context, r restful.RestAPITripper, vmId string) (*types.Task, error) {
	var reqBody *types.Common
	var api types.ICSApi
	var response = types.Task{}
	...
	api.Api = fmt.Sprintf("/vms/%s?action=pause", vmId)
	api.Token = true
...
func ResumeVMById(ctx context.Context, r restful.RestAPITripper, vmId string) (*types.Task, error) {
	var reqBody *types.Common
	var api types.ICSApi
	var response = types.Task{}
	...
	api.Api = fmt.Sprintf("/vms/%s?action=resume", vmId)
	api.Token = true
